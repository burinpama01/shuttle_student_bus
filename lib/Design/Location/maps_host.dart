...
class MapsHost extends StatefulWidget {
  ...
  MapsHostState createState() => MapsHostState();
}
...
class MapsHostState extends State<MapsHost> {
  ...
  void initState(){
    ...
    initPlatformState();
    locationSubcription = _location.onLocationChanged().listen((Map<String, double> result){
      setState(() {
  ...
  void initPlatformState() async {
    ...
    try{
      my_location = await _location.getLocation();
      error = "";
